import type { ProviderAnimeEpisodeResponse, ProviderID, ProviderSeasonResponse } from "../../@types";
import { BaseProvider } from "./baseProvider";
export declare abstract class TvProvider extends BaseProvider {
    /**
     ...
     */
    abstract episodes(season_number: number, tv_id: ProviderID): Promise<Array<ProviderAnimeEpisodeResponse>>;
}
//# sourceMappingURL=tvProvider.d.ts.map